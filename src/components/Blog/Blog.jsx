...
const Blog = () => {
    return (
        <div className='my-5' id='myAnswers'>
            ...
            <p>React state is mutable and it's value can be changed. But Props is immutable, it is read
                only. Props are used to send data from one one component to other, unidirectionally.
                State is local to a component, can not be used in other components, But Props allow child components to read values from parent comoponents.
            ...
            <p>The useEffect hook allows us to perform side effects in our components.
                Other than fetching data useEffect is also used to directly update the DOM and timers.By using this Hook, we can tell React that the component needs to do something after render.
            </p>
            </div>
            <div className='border border-3 p-3 mb-2 rounded'>
